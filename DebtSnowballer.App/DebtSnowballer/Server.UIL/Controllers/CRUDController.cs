...
namespace Server.UIL.Controllers
	...
	public class CrudController : ControllerBase
		...
		public async Task<IActionResult> GetCruds()
			...
			var cruds = await _unitOfWork.CRUDs.GetAll();
		...
		public IActionResult GetCrud(int id)
			...
			var crud = _unitOfWork.CRUDs.Get(id);
		...
		[HttpPost]
		public IActionResult Post([FromBody] CrudDto crudDto)
			{
		...
		[HttpPut("{id:int}")]
		public IActionResult Put(int id, [FromBody] CrudDto crudDto)
			{
