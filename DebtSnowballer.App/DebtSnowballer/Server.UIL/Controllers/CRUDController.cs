...
public class CrudController : ControllerBase
{
    ...
    public async Task<IActionResult> Post([FromBody] CrudDto crudDto)
    {
        ...
        _logger.LogInformation("Created new Crud item with ID {CrudId} in {ControllerName}.", createdCrudDto.Id,
    ...
    public async Task<IActionResult> Put(int id, [FromBody] CrudDto crudDto)
    {
        _logger.LogInformation("Received PUT request in {ControllerName} with ID: {Id} and DTO: {Dto}.",
            nameof(CrudController), id, crudDto);
    ...
    public async Task<IActionResult> GetCruds()
    {
        ...
        _logger.LogInformation("Returned {Count} Crud items from {ControllerName}.", results.Count,
            nameof(CrudController));
